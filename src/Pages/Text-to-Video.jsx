...
function TextVideo() {
  ...
  const ideas = [
    "A cinematic slow motion shot of a wolf in the snow",
    "A drone shot flying over a volcanic eruption",
    "A jellyfish glowing in the deep ocean",
    "A futuristic train passing through a neon city",
    "A time-lapse of a flower blooming in the forest",
  ];
  ...
  return (
    <div className="w-full min-h-screen flex flex-col font-sans bg-[url('/bg-image.png')] bg-no-repeat bg-center bg-cover bg-fixed overflow-x-hidden">
      ...
      <header className="flex items-center gap-[10px] px-6 py-4 border-b border-[#4f8fff]/15 backdrop-blur-md bg-[#060d1f]/45 shrink-0 z-50">
        ...
        <span className="font-bold text-lg md:text-xl tracking-tight text-[#e8f0ff]">Text to Video</span>
      </header>
